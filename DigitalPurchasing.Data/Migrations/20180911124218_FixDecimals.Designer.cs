...
namespace DigitalPurchasing.Data.Migrations
{
    ...
    [Migration("20180911124218_FixDecimals")]
            ...
            modelBuilder.Entity("DigitalPurchasing.Models.UnitsOfMeasurement", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("0a45a476-e69f-4ebb-bb54-0ae92c88e64b"), CreatedOn = new DateTime(2018, 9, 11, 12, 42, 18, 234, DateTimeKind.Utc), Name = "шт" },
                        new { Id = new Guid("5d8949a3-3c3d-44c0-b22e-e9ec1881faf0"), CreatedOn = new DateTime(2018, 9, 11, 12, 42, 18, 234, DateTimeKind.Utc), Name = "тыс шт" },
                        new { Id = new Guid("e6fe6c76-ef68-41dd-be4a-07f46f274334"), CreatedOn = new DateTime(2018, 9, 11, 12, 42, 18, 234, DateTimeKind.Utc), Name = "кг" }
                    );
                });
            ...
            modelBuilder.Entity("DigitalPurchasing.Models.UomConversionRate", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("f57c690a-fbb1-47e2-9ab0-1472a514d88f"), CreatedOn = new DateTime(2018, 9, 11, 12, 42, 18, 235, DateTimeKind.Utc), Factor = 1000m, FromUomId = new Guid("5d8949a3-3c3d-44c0-b22e-e9ec1881faf0"), ToUomId = new Guid("0a45a476-e69f-4ebb-bb54-0ae92c88e64b") }
                    );
                });
